...
//        tableView.setItems(data);
    ...
    public static void main(String[] args) {
     ...
     // Person若是放在內部，則必須是public靜態類別，這樣JavaFx才能讀取它(一定要public才讀得到)，否則會有以下錯誤訊息:
    // cannot access a member of class mypos.TableViewExample$Person (in module mypos)
    // Person放在外部最好，跟我們以前例行的做法一樣: 放在一個獨立的檔案Person.java 類別名稱為 public class Person{}
